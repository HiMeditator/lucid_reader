...
- [FEATURES.md](./FEATURES.md)：功能范围、阅读体验、界面多语言、AI、双语阅读、TTS、语义检索和 UI 信息架构。
...
- 界面多语言从工程基础阶段纳入，初始支持英语、中文和日语，并保留低成本添加更多语言的资源结构。
...
- 易本地化：用户可见界面文案、错误提示、空状态和设置项应通过本地化资源管理，避免在业务逻辑中写死语言。
